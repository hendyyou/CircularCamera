...
import me.jessyan.camerafilters.filter.CameraFilterBlend;
...
public class FilterManager {
     ...
     * 初始化滤镜管理器
     */
    public static FilterManager initFilterManager(Context mApplicationContext) {
        FilterManager mFilterManager = FilterManager
                .builder()
